...
SlashCmdList["BETTERQUESTHELP"] = function(msg)
    ...
    if msg:lower() == "complete" then
        ...
        if BetterQuestHelpDB.autoComplete then
            print("|cff00ff88[BQH]|r Auto-Completar misiones: |cff00ff00ACTIVADO|r")
        else
            print("|cff00ff88[BQH]|r Auto-Completar misiones: |cffff0000DESACTIVADO|r")
        end
        return
    end
    ...
    print("  /qh complete        -> Activa/Desactiva auto-completar misiones")
end
...
f:SetScript("OnEvent", function()
    ...
    if type(BetterQuestHelpDB.autoComplete) ~= "boolean" then
        BetterQuestHelpDB.autoComplete = false
    end
