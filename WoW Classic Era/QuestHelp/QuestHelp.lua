...
local function CreateHelpButton_Retail()
    ...
    btn:SetSize(70, 20)
    btn:SetText("Help")
    -- Colocamos arriba a la derecha del panel de detalles, bajando más el texto
    btn:SetPoint("TOPRIGHT", parent, "TOPRIGHT", -20, -30) -- antes era -14
...
local function CreateHelpButton_ClassicQuestFrame()
    ...
    btn:SetSize(90, 22)
    btn:SetText("Help")
    btn:SetPoint("TOPRIGHT", parent, "TOPRIGHT", -30, -40) -- antes era -30
